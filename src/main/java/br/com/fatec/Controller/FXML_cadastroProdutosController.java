...
public class FXML_cadastroProdutosController implements Initializable {
    ...
    private boolean estaVazio(){
        if(txtCategoria.getText().isEmpty() || txtDataVencimento.valueProperty() == null || txtNomeProd_Prod.getText().isEmpty() || txtQuantidade.getText().isEmpty() || txt_idProduto.getText().isEmpty()){
            return true;
        }else{
            return false;
        }
